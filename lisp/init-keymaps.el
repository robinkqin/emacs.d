...
(defvar my/avy-thing-edit-map (make-sparse-keymap)
  "Keybinding for `thing-edit'")
;; Copy.
(define-key my/avy-thing-edit-map (kbd "w") 'avy-thing-copy-word)
(define-key my/avy-thing-edit-map (kbd "s") 'avy-thing-copy-symbol)
(define-key my/avy-thing-edit-map (kbd "m") 'avy-thing-copy-email)
(define-key my/avy-thing-edit-map (kbd "f") 'avy-thing-copy-filename)
(define-key my/avy-thing-edit-map (kbd "u") 'avy-thing-copy-url)
(define-key my/avy-thing-edit-map (kbd "x") 'avy-thing-copy-sexp)
(define-key my/avy-thing-edit-map (kbd "t") 'avy-thing-copy-page)
(define-key my/avy-thing-edit-map (kbd "v") 'avy-thing-copy-sentence)
(define-key my/avy-thing-edit-map (kbd "g") 'avy-thing-copy-block)
(define-key my/avy-thing-edit-map (kbd "o") 'avy-thing-copy-whitespace)
(define-key my/avy-thing-edit-map (kbd "i") 'avy-thing-copy-list)
(define-key my/avy-thing-edit-map (kbd "c") 'avy-thing-copy-comment)
(define-key my/avy-thing-edit-map (kbd "h") 'avy-thing-copy-defun)
(define-key my/avy-thing-edit-map (kbd "p") 'avy-thing-copy-parentheses)
(define-key my/avy-thing-edit-map (kbd "l") 'avy-thing-copy-region-or-line)
(define-key my/avy-thing-edit-map (kbd "a") 'avy-thing-copy-to-line-beginning)
(define-key my/avy-thing-edit-map (kbd "e") 'avy-thing-copy-to-line-end)
;; Cut.
